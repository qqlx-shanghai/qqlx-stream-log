    ...
    imports: [
        TypeOrmModule.forRootAsync({
            ...
            useFactory: async (pondDropletMessenger: DropletHostRpc) => {
                ...
                console.log("\n---- ---- ---- tcp.module.ts");
                console.log(`droplet-location:get - ${DROPLET_SHANGHAI_POSTGRESQL}:${node_db?.lan_ip}:${node_db?.port}`);
                ...
                console.log(`droplet-location:put ing... - ${DROPLET_STREAM_LOG}:${droplet.lan_ip}:${droplet.port}`);
                console.log("---- ---- ----\n");
